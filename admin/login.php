  ...
  <div class="limiter">
    <div class="container-login100 ">
      <div class="wrap-login100"  >
        <form class="login100-form validate-form" action="" method="POST" width=100%>
          <span class="login100-form-title p-b-43" width=100%>
            Admin login
          </span>
...
<!--
        ...
        <div class="login100-more" style="background: black;">
          <img src="adminMenu/images/tutlogo4.jfif" style="object-fit: contain">
        </div>
      </div>
    </div>
  </div>
