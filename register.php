...
<section id="title-header">
  <div class="title">  
     <img class="" src=""><h1>Tshwane University of Technology</h1></img>
                 ...
                 <div class="form-group">
                    <div class="col-md-9">
                      ...
                      <div class="col-md-8">
                        ...
                        <a href="login.php"><i class="fa fa-arrow-left"></i> Click here Back to Login</a>
...
<section id="page-footer"> 
      <footer>  <p align="center">&copy; TUT2021 </p></footer>
</section>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: color:#fff;">
        <!---     <p>REMEMBER ALWAYS SANITIZE AND WASH YOUR HANDS REQULARY</P>-->
     </footer>
 </section>
